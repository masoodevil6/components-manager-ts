...
const ComponentPositionMenuConfigs  =  {
    keys: {
        ...
        [ComponentPositionMenuProps.prop_menuBodyHeight] : {
            ...
            value:               GOG_SetValue<SizeUnit | SizeCalc |null>(SizeUnit(250 , UNITS.PEXEL)),
        } ,
...
export class ComponentPositionMenu extends ComponentPositionMenuBase {
    ...
    private _FLOAT_MENU ;
    private _STATUS_SHOW_FLOAT_MENU = new Observable(false);
        ...
        if (data != null) {
            ...
            this._FLOAT_MENU = new ComponentFloatMenu(
                <ComponentFloatMenuPropsType>{
                    ...
                    prop_floatIsShow:                 this._STATUS_SHOW_FLOAT_MENU ,

                    prop_floatStyles:                 {
                        display:     "block"
                    } ,

                    prop_floatWidth:                  Observable.computed(
                        (width) => {
                            return SizeCalc(width , OPERATION.ADD , SizeUnit(20 , UNITS.PEXEL))
                        } , [prop_menuBodyWidth] , this.getScope()
                    ) ,
    ...
    private template_render_formFloatMenu_selector(attrsDefault , data , extra) : ReactiveElement {
        ...
        if (data != null) {
            ...
            return ReactiveElement.part(  "section" ,{
                ...
                on:{
                    click: (event) => {
                        const statusShow = !this._STATUS_SHOW_FLOAT_MENU.get();
                        if (statusShow){
                        ...
                        this._STATUS_SHOW_FLOAT_MENU.set(statusShow);
    ...
    private template_render_formFloatMenu_body(attrsDefault , data , extra) : ReactiveElement {
        ...
        if (data != null) {
            ...
            return ReactiveElement.part(  "section" ,{
                ...
                stylesBind: {
                    width:       prop_menuBodyWidth ,
                    height:      prop_menuBodyHeight ,
                } ,
                children: [
            ...
            return ReactiveElement.part(  "section" ,{
                ...
                styles: {
                    height : SizeCalc(
                        ...
                        OPERATION.MINUS ,
                        SizeUnit(this._HEIGHT_FORM_BUTTONS , UNITS.PEXEL) ,
                    )
                } ,
                children: [
                    prop_menuBody ,
    ...
    private template_render_formFloatMenu_body_buttons(attrsDefault , data , extra) : ReactiveElement {
        ...
        if (data != null) {
            ...
            return ReactiveElement.part(  "section" ,{
                ...
                styles: {
                    height :       SizeUnit(this._HEIGHT_FORM_BUTTONS , UNITS.PEXEL) ,
                    borderTopStyle:   "solid"
                } ,
                stylesBind: {
                    borderTopColor:   prop_menuBorderColor ,
                    borderTopWidth:      prop_menuBorderWidth.map(
                        v=>{
    ...
    private pr_handleMenuClose(checkChild , event){
        ...
        this._STATUS_SHOW_FLOAT_MENU.set(false);
