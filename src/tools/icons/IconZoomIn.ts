...
export function IconZoomIn(
    ...
    return `
<svg xmlns="http://www.w3.org/2000/svg" role="img" aria-label="zoom-in"
    ...
    <line x1="11" y1="8" x2="11" y2="14" stroke="${primaryColor}" stroke-width="${strokeWidth}" stroke-linecap="round"/>
