...
export const MTToSerializeArray = function (formElement: HTMLFormElement | null): UtilConvertor.Types.TSerializeItem[] {
    if (!formElement)
        return [];

    const result: UtilConvertor.Types.TSerializeItem[] = [];
