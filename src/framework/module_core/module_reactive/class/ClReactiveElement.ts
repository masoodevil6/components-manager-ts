...
export class ClReactiveElement {
    ...
    private _setChildren(children: any) {
       // this.element.textContent = "";
        ...
        const append = (child: any) => {
            ...
            if (child instanceof CoreObservable.App) {
                ...
                const render = (value: any) => {
                    ...
                    const insert = (v: any) => {
                        ...
                        if (v instanceof ClReactiveElement) {
            ...
            if (child instanceof ClReactiveElement) {
    ...
    static create(tagName: string, options?: Options) {
        return new ClReactiveElement(tagName, options);
    }

    static component(componentName: string ,o?: Options) { return new ClReactiveElement(`component-${componentName}`, o) }
    static part(el: string = "section" ,o?: Options) {
        ...
        return new ClReactiveElement(el, o)
    }
    ...
    static section(o?: Options) { return new ClReactiveElement("section", o) }
    static a(o?: Options) { return new ClReactiveElement("a", o) }
    static label(o?: Options) { return new ClReactiveElement("label", o) }
    static input(o?: Options) { return new ClReactiveElement("input", o) }
    static h1(o?: Options) { return new ClReactiveElement("h1", o) }
    static h2(o?: Options) { return new ClReactiveElement("h2", o) }
    static h3(o?: Options) { return new ClReactiveElement("h3", o) }
    static p(o?: Options) { return new ClReactiveElement("p", o) }
    static ul(o?: Options) { return new ClReactiveElement("ul", o) }
    static li(o?: Options) { return new ClReactiveElement("li", o) }
    static img(o?: Options) { return new ClReactiveElement("img", o) }
    static i(o?: Options) { return new ClReactiveElement("i", o) }
