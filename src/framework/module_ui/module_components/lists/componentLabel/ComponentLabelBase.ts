...
/**
 * ComponentLabelBase — ترکیب config پایه و اختصاصی (Plan 13.1.0)
 *
 * ارث از CoreComponents.App (ClComponentBase) — نه ComponentStructure.
 * ComponentLabel خودش یک Component مستقل است؛ ComponentBorder به‌عنوان فرزند
 * در renderLabelBorder از طریق Category callable استفاده می‌شود (Composition).
 *
 ...
 * به رندر اختصاصی forward می‌شوند.
 *
 * Step Node (Plan 8.2.7 / 9.1):
 ...
 */
export class ComponentLabelBase extends CoreComponents.App<
...
> {
    ...
    /**
     * Step Node — درخت Workflow داخلی ComponentLabel
     */
     ...
     *
     * @param componentName — نام Component (default: "label")
