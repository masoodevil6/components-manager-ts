...
/**
 * ComponentFloatMenuBase — ترکیب config پایه و اختصاصی
 *
 * ارث از CoreComponents.App (ClComponentBase) — نه ComponentStructure.
 * ComponentFloatMenu خودش یک Component مستقل است.
...
> {
    ...
    /**
     * Step Node — درخت Workflow داخلی ComponentFloatMenu
     */
