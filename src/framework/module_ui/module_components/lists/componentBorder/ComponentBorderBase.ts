...
/**
 * ComponentBorderBase — ترکیب config پایه و اختصاصی
 *
 * ارث از CoreComponents.App (ClComponentBase) — نه ComponentStructure.
 * ComponentBorder خودش یک Component مستقل است.
...
> {
    ...
    /**
     * Step Node — درخت Workflow داخلی ComponentBorder
     */
     ...
     *
     * @param componentName — نام Component (default: "border")
