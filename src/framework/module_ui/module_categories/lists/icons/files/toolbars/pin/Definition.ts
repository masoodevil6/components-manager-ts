...
export const Definition : TCategoryIconDefinition = {
    id:              "Pin" ,
    name:            CoreLanguage.App.translate(Keys.category.icons.filesToolbarsPin.name) ,
    description:     CoreLanguage.App.translate(Keys.category.icons.filesToolbarsPin.name ) ,
    icons:          [
