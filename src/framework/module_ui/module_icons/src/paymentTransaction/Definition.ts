...
export const Definition: IconDefinition = {
    ...
    title:       Keys.icons.paymentTransaction.name,
    description: Keys.icons.paymentTransaction.description,
    ...
    render(context) {
        ...
        return [
            ...
            // ---- Layer_3: Both arrows (deposit + withdrawal) ----
