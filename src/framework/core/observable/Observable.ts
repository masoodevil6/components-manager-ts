...
export class Observable<T> {
    ...
    subscribe(fn: Subscriber<T>, scope?: CoreObservable.Scope): () => void {
    ...
    map<U>(fn: (value: T) => U, scope?: CoreObservable.Scope): Observable<U> {
    ...
    mapBoolean<U>(trueValue: U, falseValue: U, scope?: CoreObservable.Scope): Observable<U> {
    ...
    mapList<U>(mapping: Mapping<T, U>, scope?: CoreObservable.Scope): Observable<U> {
    ...
    static computed<T>(fn: (...args: any[]) => T, observables: Observable<any>[], scope?: CoreObservable.Scope): Observable<T> {
    ...
    private _bindToScope(unsub: () => void, scope?: CoreObservable.Scope) {
        if (!scope) return;
        scope.track(unsub);
    }
