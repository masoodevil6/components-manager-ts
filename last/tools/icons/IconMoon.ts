...
export function IconMoon(
    ...
    return `
<svg xmlns="http://www.w3.org/2000/svg" role="img" aria-label="moon"
    width="${size}" height="${size}" viewBox="0 0 24 24" fill="none">
    <title>moon</title>
    <path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z" stroke="${primaryColor}" stroke-width="${strokeWidth}" stroke-linecap="round" stroke-linejoin="round" fill="${secondaryColor}"/>
</svg>` as IconString
}
