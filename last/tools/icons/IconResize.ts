...
export function IconResize(
    ...
    return `
<svg xmlns="http://www.w3.org/2000/svg" role="img" aria-label="resize"
    width="${size}" height="${size}" viewBox="0 0 24 24" fill="none">
    <title>resize</title>
    <path d="M10 4H4v6M14 4h6v6M4 14v6h6M20 14v6h-6"  stroke="${primaryColor}" stroke-width="${strokeWidth}" stroke-linecap="round" stroke-linejoin="round"/>
</svg>` as IconString;
}
