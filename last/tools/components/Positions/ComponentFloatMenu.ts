...
export const ComponentFloatMenuProps = {
    ...
    prop_floatDistance :              "prop_floatDistance" ,
...
const ComponentFloatMenuConfigs  =  {
    keys: {
        ...
        [ComponentFloatMenuProps.prop_floatDistance] : {
            name:                ComponentFloatMenuProps.prop_floatDistance,
            value:               GOG_SetValue<number>(10),
        } ,
    ...
    _COMPONENT_PATTERN=  defineComponentPatterns<ComponentFloatMenuPropsType>(
        {
            ...
            [ComponentFloatMenuConfigs.keys.prop_floatDistance.name]: {
                prop:                                             ComponentFloatMenuConfigs.keys.prop_floatDistance.name,
                default:                                          ComponentFloatMenuConfigs.keys.prop_floatDistance.value,
                title:                                            Language.translate("components.float_menu.props.prop_floatDistance.title"),
                description:                                      Language.translate("components.float_menu.props.prop_floatDistance.description"),
            } ,
    ...
    _COMPONENT_SCHEMA = defineComponentSchema<ComponentFloatMenuSchemaType  , ComponentFloatMenuPropsType>( {
        ...
        [ComponentFloatMenuConfigs.schemas.SELECTOR_POSITION_BORDER.name]: {
            ...
            props: [
                ...
                this._COMPONENT_PATTERN[ComponentFloatMenuConfigs.keys.prop_floatDirectionType.name] ,
                this._COMPONENT_PATTERN[ComponentFloatMenuConfigs.keys.prop_floatArrowWidth.name] ,
                this._COMPONENT_PATTERN[ComponentFloatMenuConfigs.keys.prop_floatDistance.name] ,
...
export class ComponentFloatMenu extends ComponentFloatMenuBase {
    ...
    private templateFn_render_selectorPosition(attrsDefault , data , extra) : ReactiveElement {
        ...
        if (data != null) {
            ...
            const prop_floatDistance  =             data[ComponentFloatMenuConfigs.keys.prop_floatDistance.name];
            ...
            return new ToolsComponents.ComponentBorder(
                <ComponentBorderPropsType>{
                    ...
                    prop_borderStyles:  Observable.computed(
                        (sizeName) => {
                            return {
                                paddingLeft:  ToolsComponents_Padding?.[sizeName] ,
                                paddingRight: ToolsComponents_Padding?.[sizeName] ,
                            }
                        } ,
                        [
