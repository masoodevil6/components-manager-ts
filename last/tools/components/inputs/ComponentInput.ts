...
#${attrsDefault.id} input[type="number"] {
                    ...
                    new ToolsComponents.ComponentBorder(
                        <ComponentBorderPropsType>{
                            ...
                            styles: Observable.computed(
                                (sizeName) => {
                                    return {
                                        paddingTop: ToolsComponents_Padding?.[sizeName]
                                    }
                                } ,
                                [
    ...
    private template_render_input(attrsDefault, data, extra): ReactiveElement {
        if (data != null) {
            ...
            this._ELEMENT_INPUT = new TOOLS.COMPONENT.SIMPLE.components.ComponentInputSimple(
                <ComponentInputSimplePropsType>{
                    classList: [],
                    prop_inputType:               prop_type ,
                    prop_inputPlaceholder:        prop_placeholder,
                    prop_inputValue:              prop_value,
                    prop_inputDisable:            prop_isDisable ,
                    prop_inputStyles:             prop_inputStyles ,
                    prop_inputClass:              prop_inputClass ,

                    prop_inputName:               Observable.computed(
                        (name)=> {
                            return `${name}[value]`
                        } ,
                        [
                    ...
                    prop_inputBorderTopLeftRadiusHas:  Observable.computed(
                        (dir)=> {
                            return !dir
                        } ,
                        [
                    ...
                    prop_inputBorderBottomLeftRadiusHas:  Observable.computed(
                        (dir)=> {
                            return !dir
                        } ,
                        [
                    ...
                    prop_inputBorderTopRightRadiusHas:  Observable.computed(
                        (dir)=> {
                            return dir
                        } ,
                        [
                    ...
                    prop_inputBorderBottomRightRadiusHas:  Observable.computed(
                        (dir)=> {
                            return dir
                        } ,
                        [
            ...
            return this._ELEMENT_INPUT = ReactiveElement.part( "section" , {
                attrs: {
                     ...attrsDefault,
                },
                stylesBind: {
            ...
            return ReactiveElement.part("section", {
                ...
                children: Observable.computed(
                    (isDisable: boolean , btnAddStatus: boolean) => {
                        ...
                        return new TOOLS.COMPONENT.SIMPLE.components.ComponentButtonSimple(
                            <ComponentButtonSimplePropsType>{
                                classList:      [],
                                styles:         {},
